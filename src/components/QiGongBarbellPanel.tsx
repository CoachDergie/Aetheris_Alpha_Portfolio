    ...
    <div className="flex flex-col items-center gap-4 w-full max-w-xl mx-auto p-2 sm:p-4 text-center">
      ...
      <div className="space-y-1">
        <h2 className="text-base sm:text-lg font-black font-mono tracking-widest text-[#ffd700] uppercase drop-shadow-[0_0_12px_rgba(255,215,0,0.6)]">
          ⚡ 6-FT BARBELL QI-GONG
        </h2>
        <p className="text-[11px] font-mono font-bold text-gray-400 uppercase tracking-wider">
          ZINC-IMBUED BARBELL // HORSE STANCE (MA BU)
        </p>
      </div>

      {/* Main Condition Card matching Headset */}
      <div className="w-full bg-gradient-to-b from-[#141b2e]/90 to-[#0a0e1a]/95 border-2 border-yellow-500/40 rounded-2xl p-4 sm:p-6 shadow-[0_0_30px_rgba(255,215,0,0.2)] flex flex-col items-center">
        <h3 className="text-sm sm:text-base font-black font-mono text-[#ffd700] uppercase tracking-wider">
        ...
        <p className="text-[11px] font-mono font-bold text-[#00e5ff] mt-0.5">
          COSMIC HOUR: {session.associatedPlanetaryHour.toUpperCase()}
        </p>

        {/* 4 Stat Blocks */}
        <div className="grid grid-cols-2 gap-3 w-full my-4 pt-4 border-t border-gray-800">
          <div className="flex flex-col items-center p-2 rounded-xl bg-black/40 border border-gray-800">
            <span className="text-[9px] font-mono font-bold text-gray-400 uppercase tracking-wider">
              BAR LENGTH
            </span>
            <span className="text-lg font-black font-mono text-[#ffd700] mt-0.5">
          ...
          <div className="flex flex-col items-center p-2 rounded-xl bg-black/40 border border-gray-800">
            ...
            <span className="text-lg font-black font-mono text-[#00e5ff] mt-0.5">
          ...
          <div className="flex flex-col items-center p-2 rounded-xl bg-black/40 border border-gray-800">
            ...
            <span className="text-lg font-black font-mono text-[#34d399] mt-0.5">
        ...
        <div className="flex items-center gap-3 w-full justify-center">
          <button
            ...
            className="flex-1 py-3 rounded-xl bg-[#ffd700] hover:bg-yellow-400 text-black font-mono font-black text-xs uppercase tracking-widest shadow-[0_0_20px_rgba(255,215,0,0.5)] transition-all hover:scale-105"
          >
            LOG REP (+4 KCAL)
          </button>
          ...
          <button
            ...
            className="p-3 rounded-xl bg-black/40 border border-gray-700 hover:border-gray-500 text-gray-400 hover:text-white transition-colors shrink-0"
            title="Reset Session"
          >
