...
export const INITIAL_GRIMOIRE_LIBRARY: DiscoveredIncantation[] = [
  ...
  },
  {
    ...
    hermeticFormula: 'EHEIEH',
    hermeticSphere: 'Daath (Knowledge)',
...
export const DISCOVERY_CATALOG: Omit<DiscoveredIncantation, 'id' | 'dateDiscovered'>[] = [
  {
    ...
    hermeticFormula: 'ELOHIM GIBOR - YHVH ELOHIM',
    hermeticSphere: 'Geburah-Binah Axis',
  ...
  },
  {
    ...
    hermeticFormula: 'YHVH ELOAH V\'DAAT',
    hermeticSphere: 'Tiphereth Solar Center',
  ...
  },
  {
    ...
    hermeticFormula: 'ELOHIM TZAQBAOTH',
    hermeticSphere: 'Hod Mercury Core',
  ...
  },
  {
    ...
    hermeticFormula: 'ADONAI HA-ARETZ',
    hermeticSphere: 'Malkuth Kingdom',
  ...
  },
  {
    ...
    hermeticFormula: 'ARARITA',
    hermeticSphere: 'Ain Soph Aur',
